...
Now we want to compare how the solvers cope with a strong shock situation ($u_L
= 15$) first in the adiabatic and then in isothermal setting with polytropic
cooling.
...
the speed of the initial velocity $u_{fast} = u_L = 15$ and a slow moving
shot up rear at the speed of around two third of the fast wave $u_{slow} \approx
2/3\,u_{fast} = 10$. 
The solutions for the strong shock setup with cooling, see
\fig{plots/sod/isothermal-supersonic/density.png}, are quite different. Most
