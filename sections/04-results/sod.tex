...
\image{1.0}{plots/sod/isothermal/pressure.png}{Foobar fo bar}
\image{1.0}{plots/sod/isothermal/velocity.png}{Foobar fo bar}

\subsubsection{Isothermal with Strong Shock}
\image{1.0}{plots/sod/isothermal-supersonic/density.png}{Foobar fo bar}
\image{1.0}{plots/sod/isothermal-supersonic/density-zoom.png}{Foobar fo bar}
\image{1.0}{plots/sod/isothermal-supersonic/pressure.png}{Foobar fo bar}
