...
Based on the considerations in \sec{governing-equations} we initialize the state
...
reference. Due to the lognormal relationship each individual fit yields very
...
a singular value which does not necessarily represents a prevalent phenomen in
...
not contractict this observation. We will put this into perspective later on.
