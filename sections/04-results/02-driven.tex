...
\image{1.0}{plots/stirturb/snapshots/forcing-stop-01.png}{Driven turbuluence; Column Sonic Mach Number and
column density along z-axis at the time when forcing is stopped: $t_d = 4.0$.}

\image{1.0}{plots/stirturb/snapshots/forcing-stop-02.png}{Driven turbuluence; Column Sonic Mach Number and
column density along z-axis at the time when forcing is stopped: $t_d = 4.0$.}

\image{1.0}{plots/stirturb/snapshots/forcing-stop-03.png}{Driven turbuluence; Column Sonic Mach Number and
column density along z-axis at the time when forcing is stopped: $t_d = 4.0$.}

\image{1.0}{plots/stirturb/snapshots/decay-01.png}{Driven turbuluence; Column Sonic Mach Number and
column density along z-axis during decay phase: $t_d = 5.0$.}

\image{1.0}{plots/stirturb/snapshots/decay-02.png}{Driven turbuluence; Column Sonic Mach Number and
column density along z-axis during decay phase: $t_d = 5.0$.}

\image{1.0}{plots/stirturb/snapshots/decay-03.png}{Driven turbuluence; Column Sonic Mach Number and
column density along z-axis during decay phase: $t_d = 5.0$.}
