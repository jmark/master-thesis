...
\image{0.8}{plots/burgers/characteristics.png}{
...
\image{0.8}{plots/burgers/solution.png}{Multiple snapshots at successive
timesteps of the initial condition $u(x,0) = 1 - \cos(x)$ evolving under the
inviscid Burger's equation (\eqn{burger}). It eventually develops a shock and
becomes multi-valued which is unphysical.}
