...
formulation, \eqn{eq:weak-formulation}, of the solution integral,
\begin{align}
...
interpolation with four sample nodes.} The Lagrange polynome of third order
...
The surface term get replaced by flux functions where an exchange of mass, momentum and
