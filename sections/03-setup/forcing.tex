...
The goal is a fully developed turbulence where the turbulent system has reached
dynamical equillibrium between energy inflow, supplied by forcing and outflow
caused by small-scale dissipation and shock capturing.
...
turbulent forcing on the first three modes.}
